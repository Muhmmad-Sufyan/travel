    ...
    return (
        <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
            <div className="flex flex-col lg:flex-row w-full gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
                {[
                    { title: 'Putuk Truno Camp', subtitle: 'Prigen, Pasuruan', backgroundImage: '/src/assets/img-1.png' },
                    { title: 'Mountain View Camp', subtitle: 'Somewhere in the Wilderness', backgroundImage: '/src/assets/img-2.png' },
