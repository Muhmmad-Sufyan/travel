...
const GetApp = () => {
    return (
        <section className=" w-full  grid md:grid-cols-2 grid-cols-1 px-9   bg-center" style={{ backgroundImage: "url('src/assets/pattern.png')" }}>
            <div className=" py-[250px] ">
                ...
                <div className="flex w-full flex-col gap-3 lg:flex-row">
                    {Button('src/assets/apple.svg', 'App Store')}
                    {Button('src/assets/android.svg', 'Play Store')}
                </div>
            </div>

            <div className="flex flex-1 items-center justify-end">
                <img src="src/assets/phone.png" alt="phones" className="w-full h-auto lg:w-auto lg:h-full" />
            </div>
        </section>
    );
};
