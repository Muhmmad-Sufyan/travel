...
const Hero = () => {
    return (
        <section className="max-container mx-[60px] padding-container grid grid-cols-1 sm:grid-cols-2 gap-10 md:gap-14 lg:py-16 xl:flex-row mt-10">
            <div className='relative z-20'>
                ...
                <div className="flex flex-col w-full gap-3 sm:flex-row">
                    ...
                    <button className="flex items-center  gap-3 rounded-full border" type="button">
                        <img src="/assets/play.svg" width='30px' alt="User Icon" />
            ...
            <div className="relative flex flex-1 items-start text-white mt-6 sm:mt-0" style={{ backgroundImage: "url('/assets/hero.png')", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }}>
